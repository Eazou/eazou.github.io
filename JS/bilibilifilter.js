...
function gltjzy() {
    let x, y = 0;
    let sytj = 0;
    sytj = Math.floor($("#reportFirst1 > div.recommend-box").width() / $(".video-card-reco").width()) * 2;
...
$(".recommend-box .btn.prev,.recommend-box .btn.next").click(function () {
    gltjzy();
})
